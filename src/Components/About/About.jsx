  ...
  return (
    <div className='about'>
        ...
        <div className="about-right"> 
            ...
            <h2>Narturing Tomorrow's Leaders Today</h2>
            <p>Embark on a transformative educational journey with our university's
               comprehensive education programs. Our cutting-edeg  curriculm is designrd needs to 
               empower students with the knowledge,skills, and experiences neeged to excel in the dynamic
